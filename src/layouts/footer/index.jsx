    ...
    <div className='footer'>
      <div className='footer-top'>
        <ul>
          ...
          <li><NavLink to="/serviceCenter">服务中心</NavLink></li>
      ...
      <div className='footer-title'>
        <div className="footerMsg">
         ...
         <p> <span>网站备案信息</span></p> 
          <p><img src="https://stride.fun/static/img/beian.d0289dc0.png" alt="" /><span>苏公安网安备32011402010859号</span></p>
          </div>
